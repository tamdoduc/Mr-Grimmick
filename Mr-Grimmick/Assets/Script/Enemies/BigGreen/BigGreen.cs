...
public class BigGreen : MonoBehaviour
{
    ...
    private Vector2 vel;
    private const float MaxVelocityXRight = 5.5f, MaxVelocityXLeft = -5.5f, MaxVelocityY = 7.5f, MaxGravity = -8f, resetTime = 0.1f, jumpTime = 0.37f;
    ...
    void CheckJump()
    {
        ...
        animator.SetFloat("Gravity", vel.y);
    }
    void CheckRange()
    {
